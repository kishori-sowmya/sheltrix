...
MATERIAL_DATABASE: Dict[str, Dict[str, Dict[str, Any]]] = {
    "wall": {
        "brick": {
            ...
            "cost_per_m2_base": 45.0, # USD equivalent / m2 per 100mm
        ...
        "cseb": {
            ...
            "max_thickness_mm": 300,
            "cost_per_m2_base": 30.0,
            "source": "Auroville Earth Institute / IS 1725:2013",
            "notes": "Low embodied energy, local Ladakh soil utilization, excellent thermal capacity.",
            "requires_validation": False,
        },
        "timber": {
        ...
        "sandwich_panel": {
            ...
            "min_thickness_mm": 50,
            "max_thickness_mm": 150,
            "cost_per_m2_base": 40.0,
            "source": "Manufacturer Technical Datasheet (Pre-fabricated Modular)",
            "notes": "Modular high-performance prefab wall panel for rapid high-altitude assembly.",
            "requires_validation": False,
        },
    },
    "roof": {
    ...
    "insulation": {
        "eps_foam": {
            ...
            "min_thickness_mm": 10,
            "max_thickness_mm": 150,
            "cost_per_m2_base": 12.0, # per 50mm
            "source": "ISO 10456",
